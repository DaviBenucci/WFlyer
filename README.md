...
**Status:** especificação normativa inicial — versão 1.0  
...
- SVG original para pauta, clave provisória, notas e compassos;
...
- identidade visual provisória, substituível quando a marca oficial for aprovada.
...
7. [`docs/07-qa/05-criterios-aceite.md`](docs/07-qa/05-criterios-aceite.md)
