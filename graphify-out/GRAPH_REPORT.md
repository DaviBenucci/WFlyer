...
2. `scripts` - 24 edges
3. `Custom angular italic W_Flyer wordmark` - 23 edges
4. `SiteExperienceShell()` - 22 edges
5. `LinkButton()` - 20 edges
6. `createPageMetadata()` - 18 edges
7. `compilerOptions` - 18 edges
8. `Normative Documentation Index` - 18 edges
...
Cohesion: 0.06
Nodes (35): ADR-0008, AttributeSnapshot, BRAND_INTRO_LABELS, BRAND_INTRO_SESSION_KEY, BrandIntroController(), HomeOpeningTargets, IntroState, IntroTarget (+27 more)
...
### Community 13 - "Mapa de IDs SVG W_Flyer"
Cohesion: 0.09
...
### Community 61 - "ApplicationDemoTablet.tsx"
Cohesion: 0.24
...
### Community 78 - "playwright.config.ts"
Cohesion: 0.22
...
### Community 118 - "RootLayout mounts theme controls while ThemeProvider resolves, applies and exposes theme state"
Cohesion: 0.40
