...
- [ ] empresa, serviços e aplicação estão apresentados;
...
- [ ] header possui compassos dos dois lados;
- [ ] marca textual está centralizada;
- [ ] pauta principal é ondulada e moderada;
- [ ] temas correspondem aos tokens provisórios;
- [ ] imagens de inspiração não foram publicadas;
- [ ] golden references foram aprovadas.

## Motion

- [ ] scroll para baixo move à esquerda;
- [ ] scroll para cima move à direita;
